...
1. Siga o roteiro do README do estudo e aponte `PastaDados` para os CSVs tratados.
...
5. Valide o total geral com o resumo JSON. Depois teste um mês e uma loja/equipe com as consultas SQL correspondentes.
